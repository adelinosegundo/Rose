...
set :domain, '192.241.181.179'
set :deploy_to, '/home/rails/application'
set :user, 'root'
set :repository, 'git@github.com:adelinosegundo/Rose.git'
set :branch, 'master'
set :unicorn_pid, "#{deploy_to}/shared/pids/application.pid"

# set :sidekiq_log, "#{deploy_to}/shared/log/sidekiq.log"
# set :sidekiq_pid, "#{deploy_to}/shared/pids/cca-simulados.sidekiq.pid"

set :rvm_path, '/usr/local/rvm/scripts/rvm'

set :shared_paths, ['config/database.yml', 'config/secrets.yml', 'log', 'sockets', 'pids']
